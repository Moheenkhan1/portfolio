...
const Projects = () => {
  return (
    <div id='projects' className=' w-screen min-h-[80vh] text-center text-white ' >
        ...
        <div className=' w-full min-h-[80%] flex flex-wrap mt-10 max-sm:mt-10 max-xl:mt-10 items-center justify-center gap-8 ' >
            <div className=' h-[84%] w-[20%] max-sm:w-[80%] max-xl:w-[40%] bg-[#161621] rounded-3xl p-5 shadow-[0px_1px_15px_rgba(125,100,212,0.5)] ' >
                ...
                <div className=' h-[10%]   w-[100%] mt-3 max-sm:mt-2 ml-2 flex flex-wrap gap-x-3 gap-y-2 max-sm:gap-x-4  ' >
                    <div className=' flex justify-center items-center w-[5rem] max-sm:w-[5rem] max-sm:text-sm
                    ...
                    <div className=' flex justify-center items-center w-[6rem] max-sm:w-[5rem] max-sm:text-sm
                    bg-[#101325] h-[1.3rem] rounded-lg shadow-[0_0px_6px_rgba(90,69,145,0.7)]  
