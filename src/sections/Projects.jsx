...
const previewImagePath =
  "/mnt/data/A_portfolio_showcase_image_on_projects_displays_fo.png";
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="bg-[#12172a] text-white py-16">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-[2.8rem] md:text-[3.4rem] font-[Anton SC] font-extrabold">
            Projects
          </h2>
          <p className="mt-3 text-lg text-[#A2A3B1]">
            A curated showcase of the most meaningful projects I’ve built,
            highlighting strong engineering and design execution.
          </p>
        </div>
          ...
          <div className="flex gap-10 items-center justify-center ">
            {projects.map((p, i) => (
              <motion.article
                ...
                animate={inView ? "show" : "hidden"}
                variants={
                  prefersReduced ? { hidden: {}, show: {} } : cardReveal
                }
                className="relative "
              >
                <div
                ...
                >
                  ...
                  <div className="p-4 flex flex-col gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        {p.live && p.live !== "#" && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-tr from-[#BE1ECC] to-[#7F17D5] text-xs font-semibold"
                          >
                            <FiLink />
                            <span className="hidden sm:inline">Live</span>
                          </a>
                        ...
                        {p.repo && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#101325] text-xs font-medium border border-white/8"
                          >
                            <FiGithub />
                            <span className="hidden sm:inline">Code</span>
                          </a>
                        ...
                        <button
                          onClick={() => setOpenId(p.id)}
                          className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/8 bg-[#0f1424] text-xs"
                        >
                          Preview
                        </button>
                      </div>
                    ...
                    <p className="text-sm text-[#A2A3B1] line-clamp-4">
                      {p.short}
                    </p>
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(90deg, rgba(190,30,236,0.18), rgba(127,23,213,0.12), rgba(63,81,181,0.06))",
                      }}
                    />
                  </div>
                </div>
      ...
      <AnimatePresence>
        {openId && (
          ...
          >
            ...
            />
            <motion.div className="relative z-50 max-w-5xl w-full bg-[#0c0f17] rounded-2xl overflow-hidden border border-white/8">
