...
//   const tx = useTransform(mx, (v) => `${v / 10}px`); // parallax strength
...
//       {/* outer gradient ring - behind (still shadow) */}
//       <motion.div
//         style={{ translateX: tx, translateY: ty }}
...
//           />
//           {/* overlay - moved behind visually (lower opacity) so image is visible */}
//           <div
...
//       {/* Orbiting badges (larger, bolder, icons included)
//           NOTE: changed animations to keyframes [0,360] with repeat Infinity so they loop continuously */}
//       {/* Orbiting badges (now in front of the portrait) */}
// <motion.div
//   initial={{ rotate: 0 }}
...
//     >
//       {/* styles for gradient shadow on name + hover glow */}
//       <style>{`
//         .gradient-shadow-name {
//           position: relative;
//           display: inline-block;
//           color: #ffffff;
//           font-weight: inherit;
//         }
//         .gradient-shadow-name::after {
//           content: "Moheenkhan";
//           position: absolute;
//           top: 0;
//           left: 0;
...
//           height: 100%;
//           z-index: -1;
//           background: linear-gradient(90deg, #BE1ECC 0%, #7F17D5 40%, #7D64D4 70%, #BE1ECC 100%);
...
//             Hi, I am <br />
//             <span className="gradient-shadow-name">Moheenkhan</span>
//           </motion.h1>
